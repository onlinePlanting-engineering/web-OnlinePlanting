													...
													<?php if ( ! empty( $link ) || ! empty( $button ) || ! empty( $link2 ) || ! empty( $button2 ) ) : ?>
														<div class="buttons">
															...
															<a href="<?php echo esc_url( $link ); ?>"
															   ...
															   title="<?php echo esc_html( $button ); ?>" class="btn btn-primary btn-lg btn-left no-js-color" <?php hestia_is_external_url( $link ); ?>><?php echo esc_html( $button ); ?></a>
															<?php } ?>
															<?php if ( ! empty( $link2 ) || ! empty( $button2 ) ) { ?>
															<a href="<?php echo esc_url( $link2 ); ?>"
															   style="<?php echo 'background-color:' . $color2; ?>"
															   title="<?php echo esc_html( $button2 ); ?>" class="btn btn-primary btn-lg btn-right no-js-color" <?php hestia_is_external_url( $link2 ); ?>><?php echo esc_html( $button2 ); ?></a>
															<?php } ?>
														</div>
													<?php endif; ?>
												</div>
